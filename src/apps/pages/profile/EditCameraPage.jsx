...
const EditCameraPage = () => {
  ...
  const handleAddCamera = () => {
    return navigate('/profile-page/rename/u12j')
  }
    ...
    <>
      <Layout>
        <div className="w-full h-15 bg-blue-gray-100 mt-15 rounded-md flex flex-row items-center justify-start px-5 gap-3">
          ...
          <p className="font-semibold text-blue-gray-800">Update Data Camera</p>
        </div>
  ...
  <div className="basis-2/5 bg-white rounded-md shadow-md p-5 flex flex-col gap-4">
    <p className="text-lg font-semibold text-blue-gray-700">Form Edit Camera</p>
